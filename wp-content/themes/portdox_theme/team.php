...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!--Start Team One-->
        <section class="team-one team-one--two team-one--two--team">
            <div class="shape1"><img src="assets/images/pattern/team-page-pattern.png" alt=""></div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__single-content">
                                ...
                                <span>FOUNDER</span>
                                <h2><a href="team-details.php">Jacob Jones</a></h2>
                                <p>Logistic service provider company plays a pivotal role in the global supply chain
                                </p>
                                <div class="btn-box">
                                    <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__single-content">
                                ...
                                <span>FOUNDER</span>
                                <h2><a href="team-details.php">Darrell Steward</a></h2>
                                <p>Logistic service provider company plays a pivotal role in the global supply chain
                                </p>
                                <div class="btn-box">
                                    <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__single-content">
                                ...
                                <span>FOUNDER</span>
                                <h2><a href="team-details.php">Theresa Webb</a></h2>
                                <p>Logistic service provider company plays a pivotal role in the global supply chain
                                </p>
                                <div class="btn-box">
                                    <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
