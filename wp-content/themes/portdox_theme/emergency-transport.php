...
<head>
    ...
    <title> Emergency Transport || portdox</title>
    <!-- favicons Icons -->
                        ...
                        <div class="service-details__sidebar">
                            <div class="service-details__sidebar-single">
                                ...
                                <div class="service-details__sidebar-single-service">
                                    <ul class="clearfix">
                                        ...
                                        <li><a href="ocean-transport.php">Safe Ocean Transport <span
                                                    class="icon-right-arrow21"></span></a></li>
                                        ...
                                        <li><a class="active" href="emergency-transport.php">Emergency Transport <span
                                                    class="icon-right-arrow21"></span></a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="service-details__sidebar-contact text-center">
                                <div class="service-details__sidebar-contact-img">
                                    <div class="inner">
                                        <img src="assets/images/resources/service-details-sidebar-img2.png" style="width:300px" alt="">
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-8">
                        <div class="service-details__content">
                            <div class="service-details__content-img1">
                                <div class="inner">
                                    <img src="assets/images/services/service-details-img8.jpg" alt="#">
                                </div>
                            </div>
