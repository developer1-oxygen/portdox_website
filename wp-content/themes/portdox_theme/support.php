        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h2><?php echo ucfirst(str_replace(".php"," ",str_replace("_"," ",basename(__FILE__))));?></h2>
                    <ul class="thm-breadcrumb">
                        <li><a href="index.php">Home</a></li>
                        <li><span class="icon-right-arrow21"></span></li>
                        <li><?php echo ucfirst(str_replace(".php"," ",str_replace("_"," ",basename(__FILE__))));?></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-12">
                        <div class="about-one__content">
                            <div class="sec-title tg-heading-subheading animation-style2">
                                ...
                                <h2 class="sec-title__title tg-element-title">Coming Soon<br>
                                </h2>
                            </div>
                        </div>
                    </div>
