<?php
/**
 * Template Name: Portdox Track Transport
 * Description: Local track transport service page (all markup in this file).
 * Assign to the Page whose slug is "track-transport" (or any title you prefer).
 *
        ...
        <section class="page-header">
            ...
            <div class="container" >
                <div class="page-header__inner" style="max-width: 500px;">
                    <h2><?php echo esc_html( get_the_title() ?: __( 'Local Track Transport', 'portdox_theme' ) ); ?></h2>
                </div>
                <div style="max-width: 500px; color: #fff; padding: 10px;">
                    <?php esc_html_e( 'Dependable local and regional trucking with visibility from pickup to delivery.', 'portdox_theme' ); ?>
                </div>
            </div>
        </section>
        <!--End Page Header-->
                            ...
                            <div class="service-details__sidebar-single">
                                ...
                                <div class="service-details__sidebar-single-service">
                                    <ul class="clearfix">
                                        ...
                                        <li><a class="active" href="<?php echo esc_url( portdox_url_for_page_slug( 'track-transport' ) ); ?>"><?php esc_html_e( 'Local Track Transport', 'portdox_theme' ); ?> <span
                                                    class="icon-right-arrow21"></span></a></li>
                    ...
                    <div class="col-xl-8">
                        <div class="service-details__content">
                            ...
                            <div class="service-details__content-text1">
                                <h2><?php esc_html_e( 'Local Track Transport', 'portdox_theme' ); ?></h2>
                            ...
                            <div class="service-details__faq">
                                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-track-transport">
