...
<head>
    ...
    <title> Safe Ocean Transport || portdox</title>
    <!-- favicons Icons -->
                        ...
                        <div class="service-details__sidebar">
                            <div class="service-details__sidebar-single">
                                ...
                                <div class="service-details__sidebar-single-service">
                                    <ul class="clearfix">
                                        <li><a href="international-transport.php">International Transport <span
                                                    class="icon-right-arrow21"></span></a></li>

                                        <li><a href="track-transport.php">Local Track Transport <span
                                                    class="icon-right-arrow21"></span></a></li>

                                        <li><a href="personal-delivery.php">Fast Personal Delivery <span
                                                    class="icon-right-arrow21"></span></a></li>

                                        <li><a class="active" href="#">Safe Ocean Transport <span
                                                    class="icon-right-arrow21"></span></a></li>

                                        <li><a href="warehouse-facility.php">Warehouse Facility <span
                                                    class="icon-right-arrow21"></span></a>
                                        </li>

                                        <li><a href="emergency-transport.php">Emergency Transport <span
                                                    class="icon-right-arrow21"></span></a>
                                        </li>
                                    </ul>
                                </div>
                             ...
                             <div class="service-details__sidebar-single">
                                <?php include_once("__download.php");?>
                            </div>

                            <div class="service-details__sidebar-contact text-center">
                                <?php include __DIR__ . '/__service-sidebar-contact-img.php'; ?>

                                <div class="service-details__sidebar-contact-content">
                                    <div class="icon">
                                        <span class="icon-phone"></span>
                                    </div>
                                    <h2><a href="tel:1234567890">+880 123 456 789</a></h2>
                    ...
                    <div class="col-xl-8">
                        <div class="service-details__content">
                            <div class="service-details__content-img1">
                                <div class="inner">
                                    <img src="assets/images/services/service-details-img7.jpg" alt="#">
                                </div>
                            </div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="text-box">
                                                    ...
                                                    <p><a href="mailto:info@portdox.com">info@logistra.com</a></p>
                                                </div>
                                            </li>
