<?php
/**
 * Template Name: Portdox Warehouse Facility
 * Description: Warehouse facility service page (all markup in this file).
 * Assign to the Page whose slug is "warehouse-facility" (or any title you prefer).
 *
        ...
        <section class="page-header">
            ...
            <div class="container" >
                <div class="page-header__inner" style="max-width: 500px;">
                    <h2><?php echo esc_html( get_the_title() ?: __( 'Warehouse Facility', 'portdox_theme' ) ); ?></h2>
                </div>
                <div style="max-width: 500px; color: #fff; padding: 10px;">
                    <?php esc_html_e( 'Secure storage, efficient handling, and reliable warehouse operations tailored to your logistics needs.', 'portdox_theme' ); ?>
                </div>
            </div>
        </section>
        <!--End Page Header-->
                            ...
                            <div class="service-details__sidebar-single">
                                ...
                                <div class="service-details__sidebar-single-service">
                                    <ul class="clearfix">
                                        ...
                                        <li><a class="active" href="<?php echo esc_url( portdox_url_for_page_slug( 'warehouse-facility' ) ); ?>"><?php esc_html_e( 'Warehouse Facility', 'portdox_theme' ); ?> <span
                    ...
                    <div class="col-xl-8">
                        <div class="service-details__content">
                            <div class="service-details__content-img1">
                                <div class="inner">
                                    <img src="<?php echo esc_url( $portdox_a ); ?>/assets/images/services/service-details-img9.jpg" alt="">
                                </div>
                            </div>

                            <div class="service-details__content-text1">
                                <h2><?php esc_html_e( 'Warehouse Facility', 'portdox_theme' ); ?></h2>
                            ...
                            <div class="service-details__faq">
                                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-warehouse">
