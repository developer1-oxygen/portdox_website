        ...
        <section class="page-header">
            ...
            <div class="container" >
                <div class="page-header__inner" style="max-width: 500px;">
                    <h2>PORTDOX NETWORK</h2>
                    
                </div>
                <div style="max-width: 500px; color: #fff; padding: 10px;">
                   The global supply chain thrives on connectivity, and so does our award-winning communication platform, enabling seamless electronic data exchange and collaboration for customers worldwide.
                </div>
            </div>
        </section>
        <!--End Page Header-->
                    ...
                    <div class="row fix_marge ">
                        <div class="col-xl-8 container">
                            <div class="team-details__top-content">
                                <div class="title-box">
                                    ...
                                    <h2 class="sec_heading">A Global Network of Supply Chain Partners at Your Fingertips</span></h2>
                                </div>
                                <div class="team-details__top-content-text">
                                    <p>
                                    Showcase your profile on The Magaya Network and reach hundreds of potential supply chain partners. Gain the ability to connect and seamlessly exchange transactions, complete with attached documentation, across Magaya databases.
                                    </p><p>
                                    Streamline operations by eliminating redundant tasks and duplicate data entry. Outbound shipments sent through the network automatically convert into inbound shipments in the destination database, enhancing efficiency across the supply chain.
                                     </p>
                        ...
                        <div class="col-xl-4">
                            <div class="team-details__top-img">
                                <div class="inner">
                                    <img src="assets/images/801.jpg" alt="" style="width:100%">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row fix_marge">
                            <div class="col-xl-4">
                                <div class="title-box">
                                    <div class="inner">
                                       <!--  <img src="assets/images/701.jpg" alt="" style="width:95%"> -->
                                    </div>    
                                    <h2 class="sec_heading_small">Expand Your Connections</h2>
                                </div>
                                <div class="team-details__top-content-text">
                                    
                                    <p style="text-align: justify;">
                                    Discover and connect with agents worldwide through the Magaya Network. Effortlessly find potential business partners and explore new opportunities across the globe.

                                    </p>

                                    <p style="text-align: justify;">
                                   Engage in real-time conversations with other network users via live chat—without ever leaving the Magaya system.
                            ...
                            <div class="col-xl-4">
                                <div class="title-box">
                                    <div class="inner">
                                       <!--  <img src="assets/images/702.jpg" alt="" style="width:95%"> -->
                                    </div>    
                                    <h2 class="sec_heading_small">Effortless Data Sharing</h2>
                                </div>
                                <div class="team-details__top-content-text">
                                    <p style="text-align: justify; ">
                                    Leverage the Magaya Network to exchange shipment information seamlessly between agents.
                                    </p>
                                    <p style="text-align: justify; ">
                                    Share essential documents like bills of lading, air waybills, packing lists, commercial invoices, and more—ensuring smooth and efficient communication throughout the supply chain.
                                    </p>
                            ...
                            <div class="col-xl-4">
                                <div class="title-box">
                                    <div class="inner">
                                        <!-- <img src="assets/images/703.jpg" alt="" style="width:95%"> -->
                                    </div>    
                                    <h2 class="sec_heading_small"> Secure Your Documents</h2>
                                </div>
                                <div class="team-details__top-content-text">
                                    <p>
                                    Say goodbye to less secure methods like EDI, FedEx, email, or fax for sharing documents.
                                    </p>

                                    <p>
                                    With the Magaya Network, all your documents are stored safely and securely within the system, ensuring maximum protection and peace of mind.
                                    </p>
