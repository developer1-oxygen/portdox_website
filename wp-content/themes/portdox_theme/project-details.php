...
<head>
    ...
    <title> Project Details || portdox</title>
    <!-- favicons Icons -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="project-details">
            <div class="container">
                <div class="project-details__inner">
                    <div class="project-details__img1">
                        <div class="inner">
                            <img src="assets/images/project/project-details-img1.jpg" alt="">
                        </div>

                        <div class="project-details__img1-content wow fadeInRight" data-wow-delay="0ms"
                            data-wow-duration="1500ms">
                            <div class="title-box">
                                <h2>Project Details</h2>
                            </div>
                            <div class="project-details__img1-content-list">
                                <ul class="clearfix">
                                    <li>
                                        <div class="title">
                                            <h2>Category:</h2>
                    ...
                    <div class="project-details__text2">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="project-details__text2-img">
                                    <div class="inner">
                                        <img src="assets/images/project/project-details-img2.jpg" alt="">

                                        <div class="project-details__video-link">
                            ...
                            <div class="col-xl-6">
                                <div class="project-details__text2-content">
                                    ...
                                    <ul>
                                        <li>
                                            <p><span class="icon-arrow-right-circle"></span> Develop recommendations for
                                                process improvements
                                                and technology i</p>
                                        </li>

                                        <li>
                                            <p><span class="icon-arrow-right-circle"></span> Create a roadmap for the
                    ...
                    <div class="project-details__text3">
                        <p>With a focus on safety, efficiency, and cost-effectiveness, we offer a range of tailored
                            services to meet the unique needs of our clients, from air and sea freight to road
                            transportation. Our dedicated team of professionals is committed to delivering excellence at
                            every stage of the journey, providing peace of mind and ensuring that your cargo arrives at
                    ...
                    <div class="project-details__previous-next">
                        <ul>
                            <li>
                                <div class="icon">
                                    <a href="#"><span class="icon-right-arrow2"></span></a>
                                </div>
                                <div class="text-box">
        ...
        <!--Start Project One-->
        <section class="project-one project-one--project-details">
            <div class="container">
                            ...
                            <div class="project-one__single-img">
                                <div class="inner">
                                    ...
                                    <div class="project-one__overlay-content">
                                        <div class="text-box">
                                            <p>Logistic</p>
                                            <h2><a href="#">Warehouse Inventory </a></h2>
                                        </div>

                                        <div class="icon">
                                            <a href="#"><span class="icon-right-arrow21"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
