        ...
        <section class="blog-page">
            <div class="container">
                <div class="row">
                 <?php
                    // Pagination logic
                    $results_per_page = 3; // Number of articles per page
                    ...
                    $query = "SELECT * FROM articles ORDER BY article_date DESC LIMIT $offset, $results_per_page";
                    $result = $conn->query($query);
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="blog-one__single">
                            <div class="blog-one__single-img">
                                <img src="<?= !empty($row['image']) ? 'article_images/' . $row['image'] : 'assets/images/blog/grid/default.jpg' ?>" alt="">
                            </div>
                            <div class="blog-one__single-content">
                                <div class="date-box">
                                    <h2><?= date("d", strtotime($row['article_date'])) ?></h2>
                                    <p><?= date("M", strtotime($row['article_date'])) ?></p>
                                </div>
                                <div class="blog-one__single-content-inner">
                                    ...
                                    <h2><a href="blog-details.php?id=<?= $row['id'] ?>"><?= htmlspecialchars($row['title']) ?></a></h2>
                                    <p><?= htmlspecialchars(substr($row['short_content'], 0, 100)) ?>...</p>
                                    <div class="btn-box">
                                        <a class="thm-btn" href="blog-details.php?id=<?= $row['id'] ?>">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <ul class="styled-pagination text-center clearfix">
                    <?php if ($page > 1): ?>
                        <li class="arrow prev"><a href="?page=<?= $page - 1 ?>"><span class="icon-right-arrow3"></span></a></li>
                    <?php endif; ?>
                    ...
                    <?php if ($page < $total_pages): ?>
                        <li class="arrow next"><a href="?page=<?= $page + 1 ?>"><span class="icon-right-arrow31"></span></a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </section>
