...
define("HOST_NAME", "Portdox Website");
define("HOST_EMAIL", "info@portdox.com");


define("SMTP_EMAIL", "info@portdox.com");
define("SMTP_PASSWORD", "vhFJ28dU2a!zcUc"); 

define("RECIPIENT_NAME", "Portdox Website");
define("RECIPIENT_EMAIL", "zeeshangill11@gmail.com");
...
try {
	...
	$mail->Host       = 'imap.oxcs.bluehost.com';                     //Set the SMTP server to send through
