...
<body>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="sidebar-textwidget">
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                <div class="logo">
                                    <a href="index.php"><img src="assets/images/resources/sidebar-logo.png"
                                            alt="" /></a>
                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <div class="text-box">
                                                            ...
                                                            <p class="text2">Mon - Sat: 8am - 5pm</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text-box">
                                                            ...
                                                            <p class="text2"><?php include __DIR__ . '/__inline-contact-email.php'; ?>
                                                            </p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text-box">
                                                            ...
                                                            <p class="text2"><a href="tel:1234567890">680 123 456
                                                                    789</a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                                ...
                                <div class="main-header-two__bottom">
                                    ...
                                    <div class="main-header-two__bottom-inner">
                                        ...
                                        <div class="main-header-two__bottom-left">
                                            <div class="main-header-two__menu">
                                                    ...
                                                    <ul class="main-menu__list">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="dropdown">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="index2.php">Header Two</a></li>
                                                                        <li><a href="index3.php">Header Three</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a href="#">One Page Styles</a>
                                                                    <ul>
                                                                        <li><a href="index-one-page.php">One Page
                                                                                Styles One</a>
                                                                        </li>
                                                                        <li><a href="index2-one-page.php">One Page
                                                                                Styles Two</a></li>
                                                                        <li><a href="index3-one-page.php">One Page
                                                                                Styles Three</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <li class="dropdown">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="international-transport.php">International
                                                                        Transport </a>
                                                                </li>
                                                                <li><a href="track-transport.php">Local Track
                                                                        Transport</a>
                                                                </li>
                                                                <li><a href="personal-delivery.php">Fast
                                                                        Personal Delivery</a>
                                                                </li>
                                                                <li><a href="ocean-transport.php">Safe Ocean
                                                                        Transport</a>
                                                                </li>
                                                                <li><a href="warehouse-facility.php">Warehouse
                                                                        Facility</a>
                                                                </li>
                                                                <li><a href="emergency-transport.php">Emergency
                                                                        Transport </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li class="dropdown">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="product-details.php">Product Details</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="blog-right-sidebar.php">Blog Right
                                                                        Sidebar</a>
                                                                </li>
                                        ...
                                        <div class="main-header-two__bottom-right">
                                            ...
                                            <div class="btn-box">
                                                <a class="thm-btn" href="contact.php">Track Order
                                                    <i class="icon-right-arrow21"></i>
                                                    <span class="hover-btn hover-bx"></span>
                                                    <span class="hover-btn hover-bx2"></span>
                                                    <span class="hover-btn hover-bx3"></span>
        ...
        <section class="banner-two">
            ...
            <div class="banner-two__img2 float-bob-x"><img src="assets/images/banner/banner-v2-img2.png" alt=""></div>
            <div class="shape1 float-bob-y"><img src="assets/images/shapes/banner-v2-shape1.png" alt=""></div>
            <div class="shape2"><img src="assets/images/shapes/banner-v2-shape2.png" alt=""></div>
                ...
                <div class="service-two__carousel owl-carousel owl-theme owl-dot-style1">
                    ...
                    <div class="service-two__single">
                        ...
                        <div class="service-two__single-content">
                            ...
                            <div class="service-two__single-content-inner text-center">
                                <h2><a href="international-transport.php">International <br>
                                        Transport</a></h2>
                    ...
                    <div class="service-two__single">
                        ...
                        <div class="service-two__single-content">
                            ...
                            <div class="service-two__single-content-inner text-center">
                                <h2><a href="international-transport.php">Local Truck <br>
                                        Transport</a></h2>
                                <p>A logistic service provider company plays a pivotal role in the global supply
                                    chain logistic service.</p>
                                <div class="btn-box">
                    ...
                    <div class="service-two__single">
                        ...
                        <div class="service-two__single-content">
                            ...
                            <div class="service-two__single-content-inner text-center">
                                <h2><a href="international-transport.php">Fast Personal <br>
                                        Delivery </a></h2>
                                <p>A logistic service provider company plays a pivotal role in the global supply
                                    chain logistic service.</p>
                                <div class="btn-box">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-5 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="project-one__title">
                            ...
                            <div class="btn-box">
                                <a class="thm-btn" href="project.php">See All Project
                                    <i class="icon-right-arrow21"></i>
                                    <span class="hover-btn hover-bx"></span>
                                    <span class="hover-btn hover-bx2"></span>
                                    <span class="hover-btn hover-bx3"></span>
                            ...
                            <div class="project-one__single-img">
                                <div class="inner">
                                    ...
                                    <div class="project-one__overlay-content">
                                        <div class="text-box">
                                            <p>Logistic</p>
                                            <h2><a href="project-details.php">Warehouse Inventory </a></h2>
                                        </div>

                                        <div class="icon">
                                            <a href="project-details.php"><span class="icon-right-arrow21"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="cta-one">
            <div class="container">
                <div class="cta-one__inner">
                    ...
                    <div class="cta-one__pattern"><img src="assets/images/pattern/cta-v1-pattern.png" alt=""></div>
                    <div class="shape1 float-bob-x"><img src="assets/images/shapes/cta-v1-shape1.png" alt=""></div>
                    <div class="shape2"><img src="assets/images/shapes/cta-v1-shape2.png" alt=""></div>
                ...
                <div class="team-one__carousel owl-carousel owl-theme owl-dot-style1">
                    ...
                    <div class="team-one__single">
                        ...
                        <div class="team-one__single-content">
                            ...
                            <span>FOUNDER</span>
                            <h2><a href="team-details.php">Courtney Henry</a></h2>
                            <p>Logistic service provider company plays a pivotal role in the global supply chain
                            </p>
                            <div class="btn-box">
                                <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--End Team One Single-->
                    ...
                    <div class="team-one__single">
                        ...
                        <div class="team-one__single-content">
                            ...
                            <span>FOUNDER</span>
                            <h2><a href="team-details.php">Jane Cooper</a></h2>
                            <p>Logistic service provider company plays a pivotal role in the global supply chain
                            </p>
                            <div class="btn-box">
                                <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
                    ...
                    <div class="team-one__single">
                        ...
                        <div class="team-one__single-content">
                            ...
                            <span>FOUNDER</span>
                            <h2><a href="team-details.php">Marvin McKinney</a></h2>
                            <p>Logistic service provider company plays a pivotal role in the global supply chain
                            </p>
                            <div class="btn-box">
                                <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
                    ...
                    <div class="team-one__single">
                        ...
                        <div class="team-one__single-content">
                            ...
                            <span>FOUNDER</span>
                            <h2><a href="contact.php">Courtney Henry</a></h2>
                            <p>Logistic service provider company plays a pivotal role in the global supply chain
                            </p>
                            <div class="btn-box">
                                <a href="contact.php">Contact Me <i class="icon-right-arrow21"></i></a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="testimonial-two__content">
                            ...
                            <div class="testimonial-two__content-btn">
                                <a class="thm-btn" href="#">See All Reviews
                                    <i class="icon-right-arrow21"></i>
                                    <span class="hover-btn hover-bx"></span>
                                    <span class="hover-btn hover-bx2"></span>
                                    <span class="hover-btn hover-bx3"></span>
        ...
        <section class="why-choose-two">
            <div class="why-choose-two__bg"
                style="background-image: url(assets/images/backgrounds/why-choose-v2-bg.jpg);">
                <div class="shape3 float-bob-x"><img src="assets/images/shapes/why-choose-v2-shape3.png" alt=""></div>
            ...
            <div class="shape1"><img src="assets/images/shapes/why-choose-v2-shape1.png" alt=""></div>
            <div class="container">
                <div class="why-choose-two__content">
                    ...
                    <div class="why-choose-two__content-bottom">
                        <div class="shape2 float-bob-x"><img src="assets/images/shapes/why-choose-v2-shape2.png" alt="">
                        </div>
                        ...
                        <div class="why-choose-two__content-bottom-content wow fadeInRight" data-wow-delay="0ms"
                            ...
                            <div class="why-choose-two__pattern2"
                                style="background-image: url(assets/images/pattern/why-choose-v2-pattern2.png);"></div>
                            <ul>
        ...
        <section class="working-process-one">
            <div class="working-process-one__pattern"
                style="background-image: url(assets/images/pattern/working-process-v1-pattern.jpg);"></div>
            <div class="container">
                <div class="shape1"><img src="assets/images/shapes/working-process-v1-shape1.png" alt=""></div>
                <div class="sec-title center text-center tg-heading-subheading animation-style2">
                    <div class="sec-title__tagline">
                        <div class="line"></div>
                        <div class="text tg-element-title">
                        ...
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__single-content">
                                ...
                                <div class="blog-one__single-content-inner">
                                    ...
                                    <h2><a href="blog-details.php">How Will You Know Success <br> When it Show Up?</a>
                                    </h2>
                                    <p>Logistic service provider company plays a pivotal role in the global supply chain
                                        ecosystem by efficiently... </p>

                                    <div class="btn-box">
                                        <a class="thm-btn" href="blog-details.php">Read More
                                            <i class="icon-right-arrow21"></i>
                                            <span class="hover-btn hover-bx"></span>
                                            <span class="hover-btn hover-bx2"></span>
                                            <span class="hover-btn hover-bx3"></span>
                        ...
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__single-content">
                                ...
                                <div class="blog-one__single-content-inner">
                                    ...
                                    <h2><a href="blog-details.php">Mastering Last Mile Delivery <br> Strategies for
                                            Success</a></h2>
                                    <p>Logistic service provider company plays a pivotal role in the global supply chain
                                        ecosystem by efficiently... </p>
                        ...
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__single-content">
                                ...
                                <div class="blog-one__single-content-inner">
                                    ...
                                    <h2><a href="blog-details.php">Logistics Announces Launch <br> of Greenhouse
                                            Gas</a></h2>
                                    <p>Logistic service provider company plays a pivotal role in the global supply chain
                                        ecosystem by efficiently... </p>
