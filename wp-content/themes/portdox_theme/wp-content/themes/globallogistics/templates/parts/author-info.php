...
if (themerex_get_custom_option("show_post_author") == 'yes') {
	...
	if ($post_data['post_type']=='post') {
		$post_author_title = esc_html__('About', 'globallogistics');
	...
	if (!empty($post_author_name)) {
		...
		<section class="post_author author vcard" itemprop="author" itemscope itemtype="http://schema.org/Person">
			...
			<h6 class="post_author_title"><?php echo esc_html($post_author_title); ?> <span itemprop="name"><a href="<?php echo esc_url($post_author_url); ?>" class="fn"><?php themerex_show_layout($post_author_name); ?></a></span></h6>
