...
if ( !function_exists( 'themerex_template_no_articles_theme_setup' ) ) {
	...
	function themerex_template_no_articles_theme_setup() {
		themerex_add_template(array(
			'layout' => 'no-articles',
			'mode'   => 'internal',
			'title'  => esc_html__('No articles found', 'globallogistics'),
			'w'		 => null,
			'h'		 => null
		));
	}
	...
	function themerex_template_no_articles_output($post_options, $post_data) {
		...
		<article class="post_item">
			<div class="post_content">
				<h2 class="post_title"><?php esc_html_e('No posts found', 'globallogistics'); ?></h2>
				<p><?php esc_html_e( 'Sorry, but nothing matched your search criteria.', 'globallogistics' ); ?></p>
