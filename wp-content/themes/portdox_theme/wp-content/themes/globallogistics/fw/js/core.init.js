...
if (typeof themerex_init_shortcodes !== 'function') {
    "use strict";
    var themerex_init_shortcodes = function () {},
		themerex_animation_shortcodes = function () {};
}
...
function themerex_ready_actions() {
	...
	jQuery('.menu_main_wrap .menu_main_responsive .menu-item-has-children').prepend('<span class="open_child_menu"></span>');

	// Submenu click handler for the responsive menu
	jQuery('.menu_main_wrap .menu_main_responsive li .open_child_menu').click(function(e) {
		"use strict";
