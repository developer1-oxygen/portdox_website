...
?>
        <table class="form-table additional_role" style="display:none">
        		<tr>
...
?>
        <h3  class="additional_role" style="display:none"><?php esc_html_e('Additional Capabilities', 'user-role-editor'); ?></h3>
<?php
