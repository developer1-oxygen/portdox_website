...
class themerex_widget_socials extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_socials', 'description' => __('Show site logo and social links', 'trx_addons') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_socials' );

		/* Create the widget. */
		parent::__construct( 'themerex_widget_socials', __('ThemeREX - Show logo and social links', 'trx_addons'), $widget_ops, $control_ops );
	}
            ...
            <?php
				if ($show_logo) {
					...
					?>
						...
						<div class="logo">
							<a href="<?php echo esc_url(home_url()); ?>"><?php echo ($logo_image ? '<img src="'.esc_url($logo_image).'" alt="">' : ''); ?>
								<span class="logo_info">
									<?php echo ($logo_text ? '<span class="logo_text">'.str_replace(array('[', ']'), array('<span class="menu_color">', '</span>'), $logo_text).'</span>' : ''); ?>
								</span>
							</a>
						</div>
					<?php
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'logo_image'=>'', 'logo_text'=>'', 'show_logo' => '1', 'show_icons' => '1', 'text'=>'', 'description' => __('Show logo and social icons', 'trx_addons') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php _e('Description:', 'trx_addons'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'logo_image' )); ?>"><?php _e('Logo image:<br />(if empty - use logo from Theme Options)', 'trx_addons'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'logo_text' )); ?>"><?php _e('Logo text:', 'trx_addons'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_logo')); ?>_1"><?php _e('Show logo:', 'trx_addons'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_logo')); ?>_1"><?php _e('Show', 'trx_addons'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_logo')); ?>_0"><?php _e('Hide', 'trx_addons'); ?></label>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_icons')); ?>_1"><?php _e('Show social icons:', 'trx_addons'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_icons')); ?>_1"><?php _e('Show', 'trx_addons'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_icons')); ?>_0"><?php _e('Hide', 'trx_addons'); ?></label>
		</p>
