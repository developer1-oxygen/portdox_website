...
class themerex_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => __('The most popular and most commented blog posts (extended)', 'trx_addons'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_popular_posts');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_popular_posts', __('ThemeREX - Most Popular & Commented Posts', 'trx_addons'), $widget_ops, $control_ops );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_popular')); ?>"><?php _e('Most popular tab title:', 'trx_addons'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_commented')); ?>"><?php _e('Most commented tab title:', 'trx_addons'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_liked')); ?>"><?php _e('Most liked tab title:', 'trx_addons'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php _e('Show', 'trx_addons'); ?></label>
