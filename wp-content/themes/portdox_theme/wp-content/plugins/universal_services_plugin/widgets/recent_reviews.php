...
class themerex_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'trx_addons'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_recent_reviews', __('ThemeREX - Recent reviews', 'trx_addons'), $widget_ops, $control_ops );
	...
	function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_2"><?php _e('As stars', 'trx_addons'); ?></label>
