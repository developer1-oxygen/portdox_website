    ...
    public function request($key = false, $api_server = false) {
        if ($this->api->action) {
            ...
            $data = array(
                ...
                'api_processor' => apply_filters('e2pdf_api_processor', get_option('e2pdf_processor') ? get_option('e2pdf_processor') : '0'),
                'api_version' => apply_filters('e2pdf_api_version', '1.18.33'),
            );
