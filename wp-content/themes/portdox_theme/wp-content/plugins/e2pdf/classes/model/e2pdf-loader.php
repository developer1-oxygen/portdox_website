...
class Model_E2pdf_Loader extends Model_E2pdf_Model {
    ...
    public function load_actions() {
        ...
        add_action('e2pdf_cronjob', array(&$this, 'cronjob'));
    }
    ...
    public function cronjob() {
        ...
        if ($model_e2pdf_bulk->get_active_bulk()) {
            $model_e2pdf_bulk->process();
        } else {
            wp_unschedule_event(wp_next_scheduled('e2pdf_cronjob'), 'e2pdf_cronjob');
        }
    }
    ...
    public function filter_cron_schedules($schedules) {
        $schedules['e2pdf_interval'] = array(
            'interval' => 5,
            'display' => __('E2Pdf Cron Job Interval', 'e2pdf')
        );
        return $schedules;
    }
