    ...
    public function import_action() {
        ...
        if ($this->post->get('_nonce')) {
            ...
            if (!$tmp) {
                ...
                $actions = apply_filters('e2pdf_controller_templates_import_actions', unserialize(base64_decode((String) $xml->template->actions)), $options, $xml, $template, $extension);

                $template->set('pages', $pages);
                $template->set('dataset_title', $dataset_title);

                if (isset($xml->template->dataset_title1)) {
                    $dataset_title1 = apply_filters('e2pdf_controller_templates_import_dataset_title1', (String) $xml->template->dataset_title1, $options, $xml, $template, $extension);
                    $template->set('dataset_title1', $dataset_title1);
                }

                if (isset($xml->template->dataset_title2)) {
                    $dataset_title2 = apply_filters('e2pdf_controller_templates_import_dataset_title2', (String) $xml->template->dataset_title2, $options, $xml, $template, $extension);
                    $template->set('dataset_title2', $dataset_title2);
                }
                ...
                if (isset($xml->template->owner_password)) {
                    $owner_password = apply_filters('e2pdf_controller_templates_import_owner_password', (String) $xml->template->owner_password, $options, $xml, $template, $extension);
                    $template->set('owner_password', $owner_password);
                }

                if (isset($xml->template->permissions)) {
                    $permissions = apply_filters('e2pdf_controller_templates_import_permissions', unserialize(base64_decode((String) $xml->template->permissions)), $options, $xml, $template, $extension);
        ...
        if ($this->post->get('_nonce')) {
            ...
            if ($this->helper->load('xml')->check()) {
                ...
                if ($template->load($this->post->get('id'))) {
                    ...
                    $dataset_title1 = apply_filters('e2pdf_controller_templates_backup_dataset_title1', $template->get('dataset_title1'), $options, $template, $template->extension());
                    $dataset_title2 = apply_filters('e2pdf_controller_templates_backup_dataset_title2', $template->get('dataset_title2'), $options, $template, $template->extension());
                    ...
                    $owner_password = apply_filters('e2pdf_controller_templates_backup_owner_password', $template->get('owner_password'), $options, $template, $template->extension());
                    $permissions = apply_filters('e2pdf_controller_templates_backup_permissions', $template->get('permissions'), $options, $template, $template->extension());
                    ...
                    $template_xml->addChildCData('dataset_title1', $dataset_title1);
                    $template_xml->addChildCData('dataset_title2', $dataset_title2);
                    ...
                    $template_xml->addChildCData('owner_password', $owner_password);
                    $template_xml->addChildCData('permissions', base64_encode(serialize($permissions)));
