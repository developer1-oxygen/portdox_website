        ...
        <div class="lrm-signin-section <?php echo !$users_can_register || $is_inline && $default_tab == 'login' ? 'is-selected' : ''; ?>"> <!-- log in form -->
            <form class="lrm-form" action="#0" data-action="login">
                ...
                <div class="fieldset">
                    ...
                    <label class="image-replace lrm-email lrm-ficon-compass" title="Company ID"></label>

                    <input name="comp_id" class="full-width has-padding has-border" type="text"  placeholder="Company ID"  value="" autocomplete="comp_id" data-autofocus="1">
