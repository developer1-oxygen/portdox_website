...
<head>
    ...
    <title> Warehouse Facility || portdox</title>
    <!-- favicons Icons -->
                            ...
                            <div class="service-details__sidebar-single">
                                ...
                                <div class="service-details__sidebar-single-service">
                                    <ul class="clearfix">
                                        ...
                                        <li><a class="active" href="warehouse-facility.php">Warehouse Facility <span
                    ...
                    <div class="col-xl-8">
                        <div class="service-details__content">
                            <div class="service-details__content-img1">
                                <div class="inner">
                                    <img src="assets/images/services/service-details-img9.jpg" alt="#">
                                </div>
                            </div>
